// app/(client)/correspondence/page.tsx
...
import { refreshCorrespondencePage } from "./actions"
...
export default async function CorrespondencePage() {
  ...
  const [pageContent, docs, previewEmail] = await Promise.all([
    getPageContent(client.clientId, "correspondence"),
    getCorrespondence(client.clientBaseId),
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader defaultTitle="Correspondence" page="correspondence" content={docs ? { ...pageContent, embed_url: null } : pageContent} />
        ...
        <>
          <div className="flex items-end justify-between gap-3 flex-wrap">
            <div className="space-y-1.5">
              {previewEmail && (
                <form action={refreshCorrespondencePage} className="print:hidden">
